...
export default function Tracker() {
  return (
    <div className="tracker-page terminal-bg select-none min-h-screen flex flex-col">
      <div className="tracker-container container max-w-1400 mx-auto pt-32 pb-20 px-6 stack gap-12 flex flex-col items-center">
        ...
        <div className="fixed top-0 left-0 w-full p-8 flex justify-between items-center border-b border-accent-alert/20 bg-black/40 backdrop-blur-md z-50">
           <div className="font-mono text-xs tracking-[0.5em] text-accent-alert uppercase animate-pulse">
              SALA_DE_GUERRA // STATUS: REVISAO_URGENTE
           </div>
           <div className="font-mono text-xs tracking-[0.3em] text-white/30 uppercase">
              LASTRO_TRACKER_V1.0
           </div>
        </div>
        ...
        <div className="grid grid-cols-12 gap-8 w-full">
              ...
              <div className="bg-accent-alert/5 border border-accent-alert/30 p-6 flex items-center justify-between rounded-sm">
                 <div className="flex items-center gap-6">
                    ...
                    <div className="stack gap-1 flex flex-col">
                       ...
                       <p className="font-mono text-xs text-accent-alert uppercase">Alvo: R$ 45.00 // Real: R$ 68.12 (Delta: +51%)</p>
                    </div>
                 </div>
                 <button className="lastro-btn !bg-accent-alert !text-white font-mono text-xs border-none px-6">
                    [ACIONAR_MICRO_PIVO]
                 </button>
              </div>
           </div>
           ...
           <div className="lg:col-span-3">
              <GlassPanel className="p-6 border-white/5 !bg-black/40 h-full flex flex-col justify-center">
                 <h3 className="font-mono text-xs text-white/20 tracking-[0.4em] uppercase mb-4">BUDGET_DISPONIVEL</h3>
           ...
           <div className="lg:col-span-3">
              <GlassPanel className="p-6 border-white/5 !bg-black/40 h-full flex flex-col justify-center">
                 <h3 className="font-mono text-xs text-white/20 tracking-[0.4em] uppercase mb-4">CUSTO_POR_LID</h3>
                 <p className="font-display text-4xl text-white">R$ 14,20</p>
                 <span className="font-mono text-xs text-emerald-500">-12% VS ONTEM</span>
              </GlassPanel>
           </div>

           <div className="lg:col-span-6">
              <GlassPanel className="p-6 border-white/5 !bg-black/40 h-full overflow-x-auto">
                 <h3 className="font-mono text-xs text-white/20 tracking-[0.4em] uppercase mb-6">EXECUCAO_AD_SPEND</h3>
